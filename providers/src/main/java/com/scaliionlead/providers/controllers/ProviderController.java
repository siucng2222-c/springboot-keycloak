package com.scaliionlead.providers.controllers;
...
import com.scaliionlead.providers.models.Provider;
...
public class ProviderController {
    private List<Provider> providers = Stream.of(new Provider("1", "provider1"), new Provider("2", "provider2"))
